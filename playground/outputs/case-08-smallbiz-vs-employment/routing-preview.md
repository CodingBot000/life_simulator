...
- Request file: `playground/outputs/case-08-smallbiz-vs-employment/routing-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-08-smallbiz-vs-employment/routing-result.json"
}
```
