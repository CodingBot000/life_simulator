...
- Request file: `playground/outputs/case-08-smallbiz-vs-employment/risk-a-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-08-smallbiz-vs-employment/risk-a-result.json"
}
```
