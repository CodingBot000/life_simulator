...
- Request file: `playground/outputs/case-02-career-growth/scenario-b-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-02-career-growth/scenario-b-result.json"
}
```
