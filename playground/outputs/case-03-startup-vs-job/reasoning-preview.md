...
- Request file: `playground/outputs/case-03-startup-vs-job/reasoning-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-03-startup-vs-job/reasoning-result.json"
}
```
