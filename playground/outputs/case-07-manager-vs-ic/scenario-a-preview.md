...
- Request file: `playground/outputs/case-07-manager-vs-ic/scenario-a-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-07-manager-vs-ic/scenario-a-result.json"
}
```
