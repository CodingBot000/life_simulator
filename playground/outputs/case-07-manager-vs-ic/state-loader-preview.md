...
- Request file: `playground/outputs/case-07-manager-vs-ic/state-loader-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-07-manager-vs-ic/state-context.json"
}
```
