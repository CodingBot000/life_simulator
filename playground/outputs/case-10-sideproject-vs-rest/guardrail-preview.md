...
- Request file: `playground/outputs/case-10-sideproject-vs-rest/guardrail-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-10-sideproject-vs-rest/guardrail-result.json"
}
```
