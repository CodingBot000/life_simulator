...
- Request file: `playground/outputs/case-05-relocation/advisor-request.json`
...
- Previous result: `playground/outputs/case-05-relocation/routing-result.json`
...
- Previous result: `playground/outputs/case-05-relocation/guardrail-result.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-05-relocation/advisor-result.json"
}
```
