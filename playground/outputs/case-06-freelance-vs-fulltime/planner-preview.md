...
- Request file: `playground/outputs/case-06-freelance-vs-fulltime/planner-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-06-freelance-vs-fulltime/planner-result.json"
}
```
