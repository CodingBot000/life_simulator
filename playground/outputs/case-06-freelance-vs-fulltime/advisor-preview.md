...
- Previous result: `playground/outputs/case-06-freelance-vs-fulltime/routing-result.json`
...
- Previous result: `playground/outputs/case-06-freelance-vs-fulltime/guardrail-result.json`
