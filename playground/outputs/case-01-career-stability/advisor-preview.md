...
- Request file: `playground/outputs/case-01-career-stability/advisor-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-01-career-stability/advisor-result.json"
}
```
