...
- Request file: `playground/outputs/case-01-career-stability/planner-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-01-career-stability/planner-result.json"
}
```
