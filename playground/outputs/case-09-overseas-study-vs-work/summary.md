# case-09-overseas-study-vs-work

- Case ID: `case-09-overseas-study-vs-work`
- Input snapshot: `playground/outputs/case-09-overseas-study-vs-work/input.json`
- Output directory: `playground/outputs/case-09-overseas-study-vs-work`

## Input Summary

- Profile: age 28, job research assistant, risk tolerance medium
- Priority: long_term_growth, short_term_income, expertise
- Option A: 해외 대학원에 진학한다
- Option B: 바로 실무 취업한다
