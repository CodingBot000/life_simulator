# Router Request Preview

- Request file: `playground/outputs/case-09-overseas-study-vs-work/routing-request.json`
- Prompt file: `prompts/router.md`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-09-overseas-study-vs-work/routing-result.json"
}
```
