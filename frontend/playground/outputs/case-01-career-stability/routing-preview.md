...
- Request file: `playground/outputs/case-01-career-stability/routing-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-01-career-stability/routing-result.json"
}
```
