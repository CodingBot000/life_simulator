...
- Request file: `playground/outputs/case-01-career-stability/guardrail-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-01-career-stability/guardrail-result.json"
}
```
