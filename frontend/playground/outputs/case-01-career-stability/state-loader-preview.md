...
- Request file: `playground/outputs/case-01-career-stability/state-loader-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-01-career-stability/state-context.json"
}
```
