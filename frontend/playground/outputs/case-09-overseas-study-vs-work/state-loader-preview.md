...
- Request file: `playground/outputs/case-09-overseas-study-vs-work/state-loader-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-09-overseas-study-vs-work/state-context.json"
}
```
