# case-02-career-growth

- Case ID: `case-02-career-growth`
- Input snapshot: `playground/outputs/case-02-career-growth/input.json`
- Output directory: `playground/outputs/case-02-career-growth`

## Input Summary

- Profile: age 29, job developer, risk tolerance high
- Priority: growth, ownership, learning
- Option A: 대기업 플랫폼팀에 남는다
...
- [advisor] advisor decision=B, confidence=0.70, guardrail_applied=false 조합이 guardrail final_mode=normal 및 위험 신호(routing risk=medium, ambiguity=medium, riskA=medium, riskB=medium)와 어떻게 연결되는지 문장 수준에서 더 직접적으로 드러나야 한다.
