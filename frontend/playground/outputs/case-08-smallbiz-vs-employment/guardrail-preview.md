# Guardrail Request Preview

- Request file: `playground/outputs/case-08-smallbiz-vs-employment/guardrail-request.json`
- Prompt file: `prompts/guardrail.md`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-08-smallbiz-vs-employment/guardrail-result.json"
}
```
