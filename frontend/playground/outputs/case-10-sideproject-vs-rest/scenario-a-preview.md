...
- Request file: `playground/outputs/case-10-sideproject-vs-rest/scenario-a-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-10-sideproject-vs-rest/scenario-a-result.json"
}
```
