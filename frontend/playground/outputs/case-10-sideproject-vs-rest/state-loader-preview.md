...
- Request file: `playground/outputs/case-10-sideproject-vs-rest/state-loader-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-10-sideproject-vs-rest/state-context.json"
}
```
