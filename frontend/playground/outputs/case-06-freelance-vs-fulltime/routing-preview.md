...
- Request file: `playground/outputs/case-06-freelance-vs-fulltime/routing-request.json`
...
```json
{
  "runner": "codex exec",
  "call_status": "ready",
  "output_file": "playground/outputs/case-06-freelance-vs-fulltime/routing-result.json"
}
```
